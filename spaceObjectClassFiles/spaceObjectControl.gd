...
func _init(tag: String, orbitData: orbit3d, shapeData: shapedObject, parent: Node3D, mu_:float, 
	...
	displayInstance = spaceObjectDisplay.new(name, orbitDisplayInstance, parent, offset)
	mu = mu_
